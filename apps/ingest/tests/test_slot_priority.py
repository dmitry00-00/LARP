...
@pytest.mark.parametrize("title,expected", [
    ...
    # donjon.ru 15.09 (RU-витрина): кириллица матчится по основе, хвост открыт
    ("Фибулы парные F-038 Готланд (Й)", "jewelry"),      # «фибула» → основа «фибул»
    ("Кирасы стальные", "cuirass"),
    ('Меч "фламберг" в ножнах (АА)', "sword_1h"),        # «в ножнах» — комплект, не ножны
    ("Гладиус с ножнами (АНТ)", "sword_1h"),
    ("Меч рыцарский тип XV с узорными ножнами", "sword_1h"),
    ("Ножны для меча", "scabbard"),                      # без предлога — ножны
    ('Венецианский палаш "Скьявона"', "sword_1h"),       # «венец» снят: ловушка префикса
    ("Подвески и амулеты O-035", "jewelry"),             # «подвес» (ножны) снят
    ("Вакидзаси с воронёным набором", "sword_1h"),       # «набор» (комплект) снят: гарнитура клинка
    ("Каролинг из Шестовицы с ножнами", "sword_1h"),     # «шест» снят
    ("Каролинг тип X из Музея Армии", "sword_1h"),
])
